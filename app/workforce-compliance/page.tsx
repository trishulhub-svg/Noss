...
const services = [
  { title: "Right to Work support", description: "Help collecting and tracking evidence. Official checks still follow GOV.UK rules where needed." },
  { title: "ID and document checks", description: "Clear requests and review support for identity evidence." },
  { title: "DBS help", description: "Coordination where the role allows it, through the correct DBS route." },
  { title: "Work history and references", description: "Organised collection so chasing takes less time." },
  { title: "Address proof", description: "Support for address history and proof where required." },
  { title: "Qualifications and registrations", description: "Evidence checks for certificates and professional registrations." },
  { title: "Licences and training", description: "Tracking for role licences, driving proof or training where needed." },
  { title: "Renewals and re-checks", description: "Help spotting renewals early so dates are harder to miss." },
];
